...
_ANGLES = [x * 45 for x in range(0, 8)]
_ANGLES_DIR = { #! 8-point compass counterclockwise
	0: "E",
	45: "NE",
	90: "N",
	135: "NW",
...
def render_8_directional_angles(path: str):
...
render_8_directional_angles(OUT_FOLDER_PATH)