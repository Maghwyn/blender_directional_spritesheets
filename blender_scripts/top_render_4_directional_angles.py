...
_ANGLES = [x * 90 for x in range(0, 4)]
_ANGLES_DIR = { #! 4-point compass counterclockwise
	0: "E",
	90: "N",
	180: "W",
	270: "S",
...
def render_4_directional_angles(path: str):
...
render_4_directional_angles(OUT_FOLDER_PATH)